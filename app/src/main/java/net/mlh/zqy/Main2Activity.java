...
public class Main2Activity extends AppCompatActivity implements CustomPopupWindow.OnItemClickListener{
    AgentWeb mAgentWeb;
    LinearLayout ll;
  ...
  // public String BASE_URL="http://13156152063.ngrok.xiaomiqiu.cn";

    public String URL = BASE_URL+"/webapp/index/loadIndex.do";
    public String TO_URL = BASE_URL+"/webapp/order/saveAlipay.do";//通知服务端支付宝支付成功的接口
    public String TO_URL2 = BASE_URL+"/webapp/order/saveWx.do";//通知服务端微信支付成功接口
    public String GET_ALIPAY = BASE_URL+"/webapp/order/payAlipay.do";//获取加密支付订单
    public String GET_WXPAY = BASE_URL+"/webapp/order/payWXClient.do ";//获取微信加密支付订单
    public String page="首页";
    public String SHARE_TV1 = "众情易,开启创业新奇迹"; //分享链接的标题
    public String SHARE_TV2 = "众情易，引领分配新纪元";//分享链接的内容
    public String SHARE_IMG = "http://www.mlhkj.net/images/logo.png";//分享链接的图片logo
    public String MARK = "";
    String appVersion;
    String appContent;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAgentWeb = AgentWeb.with(this)//传入Activity or Fragment
                ...
                .closeProgressBar()//不显示进度条
              //   .setIndicatorColorWithHeight(Color.parseColor("#C0C0C0"),1)
        ...
        setListener();
        AgentWebConfig.syncCookie(BASE_URL,"ID=cookie");//刷新同步cookies
        if(mAgentWeb!=null){
            //注入对象
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        if (keyCode == KeyEvent.KEYCODE_BACK && event.getRepeatCount() == 0) {
            if (page.equals("首页")||page.equals("分类")||page.equals("升级代理")||page.equals("购物车")||page.equals("我的")){
                exit();
            }else {
    ...
    private void setListener() {
        shareListener = new ShareListener() {
            ...
            public void shareSuccess() {
                Toast.makeText(Main2Activity.this, "分享成功", Toast.LENGTH_SHORT).show();
            }

            @Override
            public void shareFailure(Exception e) {
                Toast.makeText(Main2Activity.this, "分享失败", Toast.LENGTH_SHORT).show();
            }

            @Override
            public void shareCancel() {
                Toast.makeText(Main2Activity.this, "取消分享", Toast.LENGTH_SHORT).show();
            }
        };
    }
    ...
    private void updateUserWithTag(share share) {
        SHARE_URL = share.version;
        SHARE_TV2 = share.content;
        //设置PopupWindow中的位置
    ...
    private void callWXPay(share share) {
        String wx_appid = "wxc4e1039e65142340";//替换为自己的appid
    ...
    private void goWxPay(String s) {
        ...
        WXPay.getInstance().doPay(ss[0], new WXPay.WXPayResultCallBack() {
            @Override
            public void onSuccess() {
                Map<String, String> map = new HashMap<>();
                map.put("attach", ss[1]);
                sendUrlToServerWX(map);
            }
            @Override
    ...
    private void sendUrlToServerWX(Map<String, String> map) {
        OkHttpUtils.post()
                .url(TO_URL2)
                .params(map)
                .build()
    ...
    public void setOnItemClick(View v) {
        ...
        switch(v.getId()){
            case R.id.mRlWechat:
                ShareUtil.shareMedia(this, SharePlatform.WX, SHARE_TV1, SHARE_TV2, SHARE_URL,SHARE_IMG, shareListener);
                break;
            case R.id.mRlWeixinCircle:
                ShareUtil.shareMedia(this, SharePlatform.WX_TIMELINE, SHARE_TV1, SHARE_TV2, SHARE_URL,SHARE_IMG, shareListener);
                break;
            case R.id.mRlQQ:
                ShareUtil.shareMedia(this, SharePlatform.QQ, SHARE_TV1, SHARE_TV2, SHARE_URL, SHARE_IMG, shareListener);
                break;
            case R.id.mRlQzone:
                ShareUtil.shareMedia(this, SharePlatform.QZONE, SHARE_TV1, SHARE_TV2,SHARE_URL , SHARE_IMG, shareListener);
                break;
        }
    }
